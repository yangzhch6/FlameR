...
# NOTE(sgm): this implementation only consider outcome supervision, where the reward is a scalar.
@register_adv_est(AdvantageEstimator.MaxRL)  # or simply: @register_adv_est("maxrl")
...
def agg_loss(loss_mat: torch.Tensor, loss_mask: torch.Tensor, loss_agg_mode: str, postive_ratio: float = 1.0, negative_ratio: float = 1.0):
    """

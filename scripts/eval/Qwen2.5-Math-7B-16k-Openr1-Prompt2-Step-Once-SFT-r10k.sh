...
project_name='eval'
val_only=True
experiment_name='Qwen2.5-Math-7B-16k-Openr1-Prompt2-Step-Once-SFT-r12k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/swift-pipeline/ckpt/think-step/Qwen2.5-Math-7B-16k-think-Openr1-Prompt2-Step-Once/v0-20251222-124326/checkpoint-1461 # path to the pre-trained model
...
## data config
train_path=data/think-step-once/aime2425_amc23_math500_minerva.parquet
test_path=data/think-step-once/aime2425_amc23_math500_minerva.parquet

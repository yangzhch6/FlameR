...
project_name='eval'
val_only=True
experiment_name='Qwen2.5-Math-7B-16k-Openr1-Think-SFT-r10k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/swift-pipeline/ckpt/think/Qwen2.5-Math-7B-16k-think-openr1-46k/v0-20251215-100304/checkpoint-17172 # path to the pre-trained model
...
# train_path=data/think-step/amc23.parquet
# test_path=data/think-step/amc23.parquet
test_path=data/think/aime2425_amc23_math500_minerva.parquet

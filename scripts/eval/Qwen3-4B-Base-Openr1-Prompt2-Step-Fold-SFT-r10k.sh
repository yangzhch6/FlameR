...
project_name='eval'
val_only=True
experiment_name='Qwen3-4B-Base-Openr1-Prompt2-Step-Fold-SFT-r12k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/swift-pipeline/ckpt/think-step/Qwen3-4B-Base-Openr1-Prompt2-Step-Fold/v0-20251222-171747/checkpoint-5493 # path to the pre-trained model

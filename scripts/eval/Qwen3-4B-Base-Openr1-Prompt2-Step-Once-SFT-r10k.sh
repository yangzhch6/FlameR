...
project_name='eval'
val_only=True
experiment_name='Qwen3-4B-Base-Openr1-Prompt2-Step-Once-SFT-r12k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/swift-pipeline/ckpt/think-step/Qwen3-4B-Base-Openr1-Prompt2-Step-Once/v0-20251222-164725/checkpoint-1461 # path to the pre-trained model

...
experiment_name='Qwen2.5-Math-7B-16k-think-align-old-r10k-kl0'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/swift-pipeline/ckpt/align_old/Qwen2.5-Math-7B-16k-think-Openr1-Math-46k-S-Aligned-bs8-le1e-5/v0-20251110-040528/checkpoint-34338
ref_model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/swift-pipeline/ckpt/align_old/Qwen2.5-Math-7B-16k-think-Openr1-Math-46k-S-Aligned-bs8-le1e-5/v0-20251110-040528/checkpoint-34338
...
## data config
train_path=data/align_old/openr1-math-46k-ref.parquet  # training data path
# test_path=data/align_old/amc23.parquet
test_path=data/align_old/aime2425_amc23_math500_minerva.parquet

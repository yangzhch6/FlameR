...
experiment_name='Qwen3-1.7B-Base-Openr1MATH46K-nothink-r4k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/models/Qwen/Qwen3-1.7B-Base
train_path=data/nothink/openr1-math-46k.parquet  # training data path
test_path=data/nothink/aime2425_math500_minerva.parquet

...
experiment_name='Qwen3-4B-Base-openr1-think-bsz128-r12k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/models/Qwen/Qwen3-4B-Base # path to the pre-trained model

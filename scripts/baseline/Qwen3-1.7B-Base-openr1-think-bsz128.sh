...
experiment_name='Qwen3-1.7B-Base-openr1-think-bsz128-r8k'
model_name_or_path=/mnt/weka/home/yongxin.wang/workspace/lark/models/Qwen/Qwen3-1.7B-Base # path to the pre-trained model
...
# train_path=data/think/amc23.parquet
# test_path=data/think/amc23.parquet

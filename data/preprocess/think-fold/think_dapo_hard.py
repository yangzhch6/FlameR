...
train_dataset = pd.read_parquet("/mnt/weka/home/yongxin.wang/workspace/lark/ThoughtSyn/data/dapo-processed-hard.parquet")
...
df.to_parquet("/mnt/weka/home/yongxin.wang/workspace/lark/FlameR/data/think/dapo-17k-hard.parquet", index=False)
